describe("About Objects", function () {
    ...
    var megalomaniac = {
      ...
      battleCry: function (noOfBrains) {
        return "They are " + this.henchman + " and the" +
          Array(noOfBrains + 1).join(" " + this.mastermind); // string we specify is the separator;
            // empty array values just convert to "" empty string; that's why this appears to loop,
            // and why there are 4 Brains, not 5, because it represents the separator
      }
    };
  ...
  it("should confirm that when a function is attached to an object, 'this' refers to the object", function () {
    ...
    expect(megalomaniac.calculateAge()).toBe(2018 - 1970);
  });
